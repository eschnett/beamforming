...
format:
	clang-format -i adler32.h adler32.c cpu.cxx cpu2.cxx cuda.cu icomplex4.cxx icomplex4.hxx matmul.cu
clean:
	rm -f cpu cpu2 cuda matmul
	rm -f adler32.o cpu.o cpu2.o cuda.o icomplex4.o matmul.o
