...
constexpr size_t Jsize1 = ntimes * nfrequencies * nbeams * npolarizations;
...
void form_beams_cpu(unsigned char *restrict const Jarray,
  ...
  constexpr int m = 1; // 8;  // beams
  constexpr int n = 1; // 8;  // times
  constexpr int k = 1; // 32; // dishes
